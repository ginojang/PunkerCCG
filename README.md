...
RootNet은 지금 당장 거대한 엔진을 만드는 것이 목적이 아니다.

현재 목적은 다음과 같다.

- Mirror/KCP 의존 제거
- Unity/WebGL에서도 통하는 최소 네트워크 코어 확보
- Python / Java 서버와 빠르게 연동 가능한 프로토콜 확보
- 이후 MMO/MO 구조 확장을 위한 기반 정리

즉 현재 RootNet은:

> **작게 시작하지만, 나중에 커질 것을 전제로 한 최소 핵심 구조**
